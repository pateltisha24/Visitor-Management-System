    ...
    if not faceBoxes:
        ...
        for faceBox in faceBoxes:
            ...
            if np.sum([roi_gray]) != 0:
                ...
                y = faceBox[1] - text_height - 10 if faceBox[1] - text_height - 10 > 10 else faceBox[1] + text_height + 10
                cv2.rectangle(resultImg, (faceBox[0], y - text_height - 10), (faceBox[0] + text_width, y + baseline - 10), (0, 255, 255), cv2.FILLED)
                cv2.putText(resultImg, text, (faceBox[0], y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 2, cv2.LINE_AA)
